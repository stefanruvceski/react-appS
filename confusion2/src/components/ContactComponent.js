...
import {Breadcrumb, BreadcrumbItem, FormGroup,Form,Label,Col,Input,Button, FormFeedback} from 'reactstrap'
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" href="skype:confusion_food" className="btn btn-info"><i className="fa fa-skype"></i> Skype</a>
